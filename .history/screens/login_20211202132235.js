        ...
        <Layout style={{flex: 1}}>
            <SafeAreaView style={{ flex: 1 }}>
                ...
                <Layout style={{ flex: 1, justifyContent: 'center' }}>
                    ...
                    <Input size={'large'} value={password} onChangeText={setpassword} accessoryRight={EyeIcon} style={{marginHorizontal: 15}} placeholder={'Password'}  label={'Password'} autoCompleteType={'password'} keyboardType={'default'} autoCapitalize={'none'} secureTextEntry={!visible}/>
